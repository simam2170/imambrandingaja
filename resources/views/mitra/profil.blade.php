...
<div class="max-w-4xl mx-auto space-y-8">
    ...
    <form action="{{ route('mitra.profil.update') }}" method="POST" enctype="multipart/form-data" class="space-y-8">
        @csrf
            ...
            <div class="p-6 space-y-6">
                <div class="flex items-center gap-6 pb-6 border-b border-gray-50">
                    <div class="relative group">
                        ...
                        <label for="foto_profil" class="absolute -bottom-2 -right-2 p-2 bg-primary text-white rounded-xl shadow-lg hover:scale-110 transition-transform cursor-pointer">
