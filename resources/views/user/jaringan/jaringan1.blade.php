...
@section('content')
    ...
    <div class="mx-auto space-y-8 max-w-7xl">
        ...
        <nav class="flex text-sm text-gray-500">
            ...
            <span class="font-medium text-gray-800">Jaringan 1</span>
        </nav>
            ...
            <div class="space-y-6 lg:col-span-1 lg:sticky lg:top-28 self-start">
                ...
                <div class="p-6 text-center bg-white border border-gray-100 shadow-sm rounded-xl">
                    <div class="relative w-32 h-32 mx-auto mb-4 overflow-hidden bg-gray-100 border-4 border-white rounded-full shadow-md">
                         <!-- Using a placeholder 'A' or generic image since Jaringan 1 had 'A' in the code previously -->
                         <div class="flex items-center justify-center w-full h-full text-5xl font-bold text-gray-400">A</div>
                    </div>
                    
                    <h1 class="text-xl font-bold text-gray-900">Jaringan Alpha</h1>
                    <p class="mt-1 text-sm text-gray-500">Professional Media & Branding Partner</p>
                    ...
                    <div class="grid grid-cols-1 gap-4 md:grid-cols-2">
                        <div class="flex flex-col p-4 transition-all bg-white border border-gray-200 rounded-xl hover:shadow-md group">
                             <div class="flex items-start justify-between mb-2">
                                 <h3 class="font-bold text-gray-800 transition-colors group-hover:text-primary">Youtube Podcast Package</h3>
                                 <span class="px-2 py-1 text-xs font-bold rounded text-primary bg-green-50">Rp 1.000k</span>
                             </div>
                             <p class="flex-1 mb-4 text-sm text-gray-500">
                                 Paket lengkap rekaman, editing, dan upload podcast durasi 30 menit. Termasuk thumbnail design.
                             </p>

                             <div class="flex items-center justify-between pt-3 mt-auto border-t border-gray-100">
                                 <span class="text-xs text-gray-400">⏱️ 3 Hari Kerja</span>
                                 <a href="{{ url('/user/jaringan/layanan/1YTpodcast') }}"
                        ...
                        <div class="flex flex-col p-4 transition-all bg-white border border-gray-200 rounded-xl hover:shadow-md group">
                             ...
                             <div class="flex items-center justify-between pt-3 mt-auto border-t border-gray-100">
                                 <span class="text-xs text-gray-400">⏱️ 3 Hari Kerja</span>
                                 <button class="px-4 py-1.5 bg-primary text-white text-sm font-semibold rounded-lg hover:bg-green-600 transition shadow-lg shadow-green-200">
                                     Pesan Sekarang
                                 </button>
                             </div>
                        </div>
                ...
                <div>
                    <h2 class="flex items-center gap-2 mb-4 text-xl font-bold text-gray-900">
                        <span class="p-2 text-blue-600 bg-blue-100 rounded-lg">
                            <svg xmlns="http://www.w3.org/2000/svg" class="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 20H5a2 2 0 01-2-2V6a2 2 0 012-2h10a2 2 0 012 2v1m2 13a2 2 0 01-2-2V7m2 13a2 2 0 002-2V9a2 2 0 00-2-2h-2m-4-3H9M7 16h6M7 8h6v4H7V8z"/></svg>
                        </span>
                        Publikasi & Berita
                    </h2>
                    ...
                    <div class="grid grid-cols-1 gap-4 md:grid-cols-2">
                        ...
                        <div class="flex flex-col p-4 transition-all bg-white border border-gray-200 rounded-xl hover:shadow-md group">
                             <div class="flex items-start justify-between mb-2">
                                 <h3 class="font-bold text-gray-800 transition-colors group-hover:text-blue-600">Liputan Khusus / Press Release</h3>
                             ...
                             <div class="flex items-center justify-between pt-3 mt-auto border-t border-gray-100">
                                 ...
                                 <button class="px-4 py-1.5 bg-blue-600 text-white text-sm font-semibold rounded-lg hover:bg-blue-700 transition shadow-lg shadow-blue-200">
                                     Pesan Sekarang
                                 </button>
                             </div>
                        </div>
