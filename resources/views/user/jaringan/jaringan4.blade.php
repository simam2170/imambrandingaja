...
@section('content')
    ...
    <div class="max-w-7xl mx-auto space-y-8">
        ...
        <nav class="flex text-sm text-gray-500">
            ...
            <span class="text-gray-800 font-medium">Jaringan Delta</span>
        </nav>
            ...
            <div class="lg:col-span-1 space-y-6 lg:sticky lg:top-28 self-start">
                <div class="bg-white p-6 rounded-xl shadow-sm border border-gray-100 text-center">
                    <div class="w-32 h-32 mx-auto bg-gray-100 rounded-full mb-4 overflow-hidden border-4 border-white shadow-md relative">
                         <!-- Reusing jaringan3 image for now as requested by initial file content list, or similar -->
                         <img src="{{ asset('img/jaringan/jaringan3.png') }}" class="w-full h-full object-contain p-2">
                    </div>
                    
                    <h1 class="text-xl font-bold text-gray-900">Jaringan Delta</h1>
                    <p class="text-gray-500 text-sm mt-1">SEO & Content Writing</p>
                    ...
                    <div class="flex items-center justify-center gap-1 mt-3">
                         ...
                         <span class="text-gray-600 font-semibold text-sm">4.7</span>
                         <span class="text-gray-400 text-sm">(50 Reviews)</span>
                    </div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        <div class="bg-white p-4 rounded-xl border border-gray-200 hover:shadow-md transition-all group flex flex-col">
                             <div class="flex items-start justify-between mb-2">
                                  <h3 class="font-bold text-gray-800 group-hover:text-primary transition-colors">Artikel SEO Premium</h3>
                                 <span class="text-primary font-bold bg-primary/10 px-2 py-1 rounded text-xs">Rp 150k</span>
                             </div>
                             <p class="text-sm text-gray-500 mb-4 flex-1">
                                 Artikel 1000 kata, riset keyword mendalam, dan optimasi SEO on-page.
                             </p>
