                        ...
                        @forelse($mitra->layanan as $layanan)
                            <div
                                ...
                                <div class="flex items-start justify-between mb-2">
                                    <h3 class="font-bold text-gray-800 transition-colors group-hover:text-primary line-clamp-2">
                                        {{ $layanan->nama_layanan }}
                                    </h3>
                                    <span
                                        class="px-2 py-1 text-xs font-bold rounded text-primary bg-green-50 shrink-0 whitespace-nowrap">Rp
                                ...
                                <div class="flex items-center gap-2 mb-2">
                                    ...
                                    <div class="flex items-center gap-0.5 ml-auto">
                                        ...
                                        @if($lCount > 0)
                                            <span class="text-[11px] font-bold text-gray-700">{{ number_format($lAvg, 1) }}</span>
                                            <span class="text-[10px] text-gray-400">({{ $lCount }})</span>
                                        @else
                                            <span class="text-[10px] text-gray-400 italic">Baru</span>
                                        @endif
                                    </div>
                                </div>
                                ...
                                <div class="flex items-center justify-between pt-3 mt-auto border-t border-gray-100">
                                    <span class="text-xs text-gray-400">⏱️ {{ $layanan->estimasi_hari ?? '3' }} Hari
                                        Kerja</span>
